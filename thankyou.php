...
<body>
    ...
    <main role="main">
        <div id="contact" class="album py-5 bg-light">
            <div class="container">
                <h1>Thank You!</h1>
                <p>You should hear back from me shortly. Thank you for reaching out!</p>
                <img src="img/cat.gif" alt="Black cat swaying happily">
            </div>
        </div>
    </main>
    ...
    <footer class="text-muted">
        <div class="container centered">
            <a href="https://www.linkedin.com/in/amandamangiarelli"><i class="fab fa-linkedin fa-2x"></i></a>
            <a href="https://www.github.com/amandamangiarelli"><i class="fab fa-github-square fa-2x"></i></a>
